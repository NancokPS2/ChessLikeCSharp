...
public static partial class Global
{
	...
	static Global()
	{
		Console.WriteLine(Global.Directory.GetContentDir(EDirectory.GAME_CONTENT));
		Console.WriteLine(Global.Directory.GetContentDir(EDirectory.USER_CONTENT));
		Global.SetupManagers();
	}
