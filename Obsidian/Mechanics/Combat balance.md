...
### Base numbers
- Health = 100
- Damage = 40 (3 TTK vs 0% reduction | 5 TTK vs 45% reduction (22 dmg))
	- With 50% boost = 60 ( 2 TTK | 3 TTK vs 45% reduction (33 dmg))
- Energy = 40
	- Regen = 10
...
| BUFF | TURNS BUFFING | DMG  | TURNS ATTACKING | TOTAL TURNS | DMG/TURN |
| ---- | ------------- | ---- | --------------- | ----------- | -------- |
| 50%  | 1             | 150% | 1               | 2           | 50%      |
| 50%  | 1             | 150% | 2               | 3           | 100%     |
| 50%  | 2             | 200% | 2               | 4           | 100%     |
...
| 75%  | 1             | 175% | 3               | 4           | 131,25%  |
| 75%  | 2             | 250% | 3               | 5           | 150%     |
*DMG/TURN = (DMG * TURNS ATTACKING) / TOTAL TURNS*
### Opportunity cost
...
All jobs should have a way to heal or survive in the absence of a dedicated healer. Due to healers being so essential to all strategies in usual strategy games. Granting healing to other jobs makes healing focused jobs less mandatory and invites more freedom 

## Encounters 
### Unit count
Combat is meant to be balanced around a [[Unit]] count from 4 to 8. 
3 units attacking simultaneously are enough to kill an enemy in 1 turn. 4 are enough even if the target has buffed survivability buffed.

### Unit placement
Units should have enough spacing for at least 1 turn of free action before ranged units can come into range.
Meelee units should take at least 2.
