...
public partial class CombatPreparationManager : Node3D
{
	...
	public override void _Ready()
	{
		...
		EventBus.EncounterMobCreated += OnEncounterMobCreated;
	}

	protected bool PlaceMob(Vector3i cellPos, Mob selectedMob)
	{
	...
	private void OnEncounterMobCreated(Mob mob, Vector3i where)
	{
		PlaceMob(where, mob);
	}
    #endregion
